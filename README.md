...
- **Weather Forecast** - Shows temp, current condition, weather, hourly 9 hours in advance, daily 5 days, and current.
  - Also shows time in selected city. When wifi is off the clock keeps ticking, the weather dissapears. Has a refresh button for manual refresh.
...
```
- **Copy the script content, you can find the script on the above instructions under the name weather_script.py or go [HERE](https://github.com/Pesicp/desk.mate.zero/blob/main/weather_script.py)**
